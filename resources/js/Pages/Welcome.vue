...
<template>
    ...
    >
        <div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            <Link
                v-if="$page.props.auth.user" :href="route('dashboard')" class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</Link>

                <Link v-if="$page.props.auth.user" :href="route('etsy.index')" class="text-sm text-gray-700 dark:text-gray-500 underline mx-3">Etsy</Link>
